...
const Cta = () => {
  return (
    <section className="bg-peach-primary my-6 mx-4 md:mx-0 px-6 md:px-24 py-16 lg:py-[72px] text-center lg:text-start rounded-2xl lg:flex lg:items-center lg:justify-between relative z-30 -mb-10 translate-y-36 md:mb-0 md:translate-y-20 lg:translate-y-24 overflow-hidden">
      <Image
