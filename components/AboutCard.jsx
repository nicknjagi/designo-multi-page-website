...
const AboutCard = () => {
  return (
    <section className="text-white text-center lg:text-left max-w-[420px] md:max-w-[689px] lg:max-w-[1111px] mx-auto overflow-hidden lg:grid lg:grid-cols-2">
        <div className="relative sm:rounded-t-2xl lg:rounded-l-none lg:rounded-r-2xl lg:order-1 overflow-hidden z-20">
            <Image
        ...
        <div className="bg-peach-primary px-6 md:px-[58px] py-20 md:py-16 relative sm:rounded-b-2xl lg:rounded-b-none lg:rounded-l-2xl lg:grid lg:content-center">
