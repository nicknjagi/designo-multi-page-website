...
const Footer = () => {
  ...
  return ( 
    <footer className={`bg-dark-bg text-center md:text-left  pb-16 md:pb-20 ${pathname === '/contact' ? 'pt-16 md:pt-20' : 'pt-64 md:pt-40 lg:pt-44'}`}>
      <div class="max-w-[1111px] px-4 md:px-8 xl:px-0 mx-auto">
        <div className='flex flex-col md:flex-row md:justify-between items-center md:border-b border-[#979797] border-opacity-20 md:pb-10 md:mb-8'>
          ...
          <ul className='text-white text-sm flex flex-col items-center md:flex-row gap-6 md:gap-10 mb-12 md:mb-0'>
            <li className='w-fit border-b border-transparent hover:border-b-white transition ease-in-out origin-left'>
